...
${filtered.slice(0, 5).join("\n")}`;
      ...
      function preloadAssets(remoteInfo, host, assets, useLinkPreload = true) {
        ...
        if (host.options.inBrowser) {
          entryAssets.forEach((asset) => {
            ...
            if (module2) require_load$4.getRemoteEntry({
              origin: host,
 ...
 ${(0, _module_federation_sdk$5.safeToString)(this.remoteInfo)}`);
      ...
      const __mfResolveGlobalKey = "__mf_init____mf__virtual/user__mf_v__runtimeInit__mf_v__.js__";
      ...
      async function getLocalSharedImportMap() {
        localSharedImportMapPromise ??= __vitePreload(() => module.import("./assets/localSharedImportMap-oDSjcqcx.js"), false ? __VITE_PRELOAD__ : void 0);
        return localSharedImportMapPromise;
      }
      async function getExposesMap() {
        exposesMapPromise ??= __vitePreload(() => module.import("./assets/virtualExposes-U7Yf17UW.js"), false ? __VITE_PRELOAD__ : void 0).then((mod) => mod.default ?? mod);
