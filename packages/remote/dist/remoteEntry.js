...
${filtered.slice(0, 5).join("\n")}`;
 ...
 ${(0, _module_federation_sdk$5.safeToString)(this.remoteInfo)}`);
      ...
      const __mfResolveGlobalKey = "__mf_init____mf__virtual/__mfe_internal__user__mf_v__runtimeInit__mf_v__.js__";
      ...
      const mfName = "__mfe_internal__user";
      let runtimeInstance;
      ...
      async function getLocalSharedImportMap() {
        if (!localSharedImportMapPromise) {
          localSharedImportMapPromise = retrySharedInit(() => __vitePreload(() => module.import("./assets/_virtual_mf-localSharedImportMap___mfe_internal__user-Crs0_SsL.js"), false ? __VITE_PRELOAD__ : void 0)).catch((e) => {
      ...
      async function getExposesMap() {
        if (!exposesMapPromise) {
          exposesMapPromise = retrySharedInit(() => __vitePreload(() => module.import("./assets/virtualExposes-BJt8qXli.js"), false ? __VITE_PRELOAD__ : void 0)).then((mod) => mod.default ?? mod).catch((e) => {
      ...
      async function init(shared2 = {}, initScope = []) {
        ...
        if (__mfModuleCache.share["react"] === void 0) {
          const mod = await __vitePreload(() => module.import("./assets/__mfe_internal__user__loadShare__react__loadShare__.mjs-wYHGoMjd.js").then((n) => n.a), false ? __VITE_PRELOAD__ : void 0);
        ...
        if (__mfModuleCache.share["react-dom"] === void 0) {
          const mod = await __vitePreload(() => module.import("./assets/__mfe_internal__user__loadShare__react_mf_2_dom__loadShare__.mjs-BSpOJ0tS.js").then((n) => n.a), false ? __VITE_PRELOAD__ : void 0);
          const exportModule = { ...mod };
          Object.defineProperty(exportModule, "__esModule", {
            value: true,
            enumerable: false
