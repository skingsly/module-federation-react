...
${filtered.slice(0, 5).join("\n")}`;
 ...
 ${(0, _module_federation_sdk$5.safeToString)(this.remoteInfo)}`);
      ...
      const __mfResolveGlobalKey = "__mf_init____mf__virtual/host__mf_v__runtimeInit__mf_v__.js__";
      ...
      async function getLocalSharedImportMap() {
        localSharedImportMapPromise ??= __vitePreload(() => module.import("./assets/localSharedImportMap-Du1-S2qE.js"), false ? __VITE_PRELOAD__ : void 0);
        return localSharedImportMapPromise;
      }
      async function getExposesMap() {
        exposesMapPromise ??= __vitePreload(() => module.import("./assets/virtualExposes-DwDlP2P6.js"), false ? __VITE_PRELOAD__ : void 0).then((mod) => mod.default ?? mod);
