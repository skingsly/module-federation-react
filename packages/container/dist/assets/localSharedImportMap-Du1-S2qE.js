  ...
  return {
    ...
    execute: (function() {
      const importMap = {
        ...
        "react": async () => {
          let pkg = await __vitePreload(() => module.import("./index-Holl59_g.js").then((n) => n.i), false ? __VITE_PRELOAD__ : void 0);
          return pkg;
        },
        "react-dom": async () => {
          let pkg = await __vitePreload(() => module.import("./index-CSEGGC1Z.js").then((n) => n.i), false ? __VITE_PRELOAD__ : void 0);
          return pkg;
        },
        "react-router": async () => {
          let pkg = await __vitePreload(() => module.import("./index-DqjvBJ8Z.js"), false ? __VITE_PRELOAD__ : void 0);
          return pkg;
        }
      };
