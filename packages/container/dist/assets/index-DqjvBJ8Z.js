System.register(["./host__loadShare__react__loadShare__.js-2sScsQri.js"], (function(exports, module) {
  "use strict";
  var __mf_25, __mf_24, __mf_14, __mf_37, __mf_38, __mf_20, __mf_33, __mf_16, __mf_3, __mf_34, __mf_28, __mf_13, __mf_2, __mf_12, __mf_1, __mf_17, __mf_30, __mf_19, __mf_7, React4, React3;
  return {
    setters: [(module2) => {
      __mf_25 = module2.e;
      __mf_24 = module2.f;
    ...
    execute: (function() {
      ...
      var Action = exports("NavigationType", /* @__PURE__ */ ((Action2) => {
        Action2["Pop"] = "POP";
        Action2["Push"] = "PUSH";
      ...
      var _map;
      var RouterContextProvider = exports("RouterContextProvider", class {
        /**
      ...
      var redirect = exports("redirect", (url, init = 302) => {
      ...
      var redirectDocument = exports("redirectDocument", (url, init) => {
        let response = redirect(url, init);
        response.headers.set("X-Remix-Reload-Document", "true");
        return response;
      });
      var replace = exports("replace", (url, init) => {
        let response = redirect(url, init);
        response.headers.set("X-Remix-Replace", "true");
        return response;
      });
      var ErrorResponseImpl = exports("UNSAFE_ErrorResponseImpl", class {
...
`,
      ...
      var DataRouterContext = exports("UNSAFE_DataRouterContext", __mf_13(null));
      DataRouterContext.displayName = "DataRouter";
      var DataRouterStateContext = exports("UNSAFE_DataRouterStateContext", __mf_13(null));
      DataRouterStateContext.displayName = "DataRouterState";
      var RSCRouterContext = __mf_13(false);
      function useIsRSCRouterContext() {
        return __mf_25(RSCRouterContext);
      }
      var ViewTransitionContext = exports("UNSAFE_ViewTransitionContext", __mf_13({
        isTransitioning: false
      }));
      ViewTransitionContext.displayName = "ViewTransition";
      var FetchersContext = exports("UNSAFE_FetchersContext", __mf_13(
        /* @__PURE__ */ new Map()
      ));
      FetchersContext.displayName = "Fetchers";
      var AwaitContext = __mf_13(null);
      AwaitContext.displayName = "Await";
      var AwaitContextProvider = exports("UNSAFE_AwaitContextProvider", (props) => __mf_14(AwaitContext.Provider, props));
      var NavigationContext = exports("UNSAFE_NavigationContext", __mf_13(
        null
      ));
      NavigationContext.displayName = "Navigation";
      var LocationContext = exports("UNSAFE_LocationContext", __mf_13(
        null
      ));
      LocationContext.displayName = "Location";
      var RouteContext = exports("UNSAFE_RouteContext", __mf_13({
        outlet: null,
        matches: [],
        isDataRoute: false
      }));
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
      ...
      var hydrationRouteProperties = exports("UNSAFE_hydrationRouteProperties", [
        "HydrateFallback",
      ...
      var createRoutesFromElements = exports("createRoutesFromElements", createRoutesFromChildren);
...
`
      ...
      var SingleFetchRedirectSymbol = exports("UNSAFE_SingleFetchRedirectSymbol", /* @__PURE__ */ Symbol("SingleFetchRedirect"));
      ...
      var FrameworkContext = exports("UNSAFE_FrameworkContext", __mf_13(void 0));
...
import(${JSON.stringify(manifest.entry.module)});`;
      ...
      var RemixErrorBoundary = exports("UNSAFE_RemixErrorBoundary", class extends __mf_2 {
        constructor(props) {
          super(props);
      ...
      var NavLink = exports("NavLink", __mf_16(
      ...
      var createCookie = exports("createCookie", (name, cookieOptions = {}) => {
        let { secrets = [], ...options } = {
          path: "/",
          sameSite: "lax",
          ...cookieOptions
      ...
      var isCookie = exports("isCookie", (object) => {
      ...
      var ServerMode = exports("UNSAFE_ServerMode", /* @__PURE__ */ ((ServerMode2) => {
      ...
      var createRequestHandler = exports("createRequestHandler", (build, mode) => {
        let _build;
        let routes;
        let serverMode;
        let staticHandler;
...
${String(error)}`;
      ...
      var createSession = exports("createSession", (initialData = {}, id = "") => {
      ...
      var isSession = exports("isSession", (object) => {
